...
namespace WeChatHelloWorld1.Controllers
{
    public class CustomerOrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerOrderID,MerchantID,CourierName,CourierPhone,CustomerID,CustomerName,CustomerPhone,DeliveryAdress,DeliveryX,DeliveryY")] CustomerOrder customerOrder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerOrderID,MerchantID,CourierName,CourierPhone,CustomerID,CustomerName,CustomerPhone,DeliveryAdress,DeliveryX,DeliveryY")] CustomerOrder customerOrder)
        {
            if (ModelState.IsValid)
            {
